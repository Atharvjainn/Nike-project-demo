  ...
  return (
    <section className='padding-x  w-full'>
        <div className='max-w-[1440px] w-full pt-30 pb-15 flex flex-col gap-2'>
            <h1 className='text-center text-3xl sm:text-4xl font-montserrat font-bold sm:leading-14 leading-10'>ORDER <span className='text-coral-red'>PLACED </span> SUCCESSFULLY!!</h1>
